...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/apps/flexsearch.min.js');loadScript('/apps/en.search-data.min.418c8b60f061e203dae7312c9d0fd78b209c8b9b14df8777930711630697bedb.js',function(){input.required=false;search();});}
