...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/apps/flexsearch.min.js');loadScript('/apps/en.search-data.min.1b1a011f185001aadf59a2f2cdcd7cdcb07f0a95478934f70fe1bac63b77c86f.js',function(){input.required=false;search();});}
