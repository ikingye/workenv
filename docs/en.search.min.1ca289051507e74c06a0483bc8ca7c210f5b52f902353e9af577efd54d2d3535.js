...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/Programmer-Interview-Checklist/flexsearch.min.js');loadScript('/Programmer-Interview-Checklist/en.search-data.min.799fee642e756414ca4ef59166a525da981ed8640062fec6e2eab4e0b1dcb689.js',function(){input.required=false;search();});}
