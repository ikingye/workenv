...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/workenv/flexsearch.min.js');loadScript('/workenv/en.search-data.min.3d865492e54d238c173a50da007be6147add41dd52462ba8b4609c3ee8eb5e53.js',function(){input.required=false;search();});}
