...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/apps/flexsearch.min.js');loadScript('/apps/en.search-data.min.83c5d7c47fa1be139536356029af24be01845492f5ce1bcb8f96febb95c815e4.js',function(){input.required=false;search();});}
