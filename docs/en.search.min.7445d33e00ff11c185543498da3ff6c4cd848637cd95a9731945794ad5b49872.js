...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/apps/flexsearch.min.js');loadScript('/apps/en.search-data.min.595d3c7e918e81d469aec3920401668a60bd7ce4b606ec67dfb64a70f6b898bf.js',function(){input.required=false;search();});}
