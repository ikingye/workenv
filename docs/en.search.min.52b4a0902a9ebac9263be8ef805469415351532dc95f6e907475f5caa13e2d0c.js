...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/workenv/flexsearch.min.js');loadScript('/workenv/en.search-data.min.6db372e54a7dd0e2f247c4faee27fa7120d47579c532f475e88a23999df16eea.js',function(){input.required=false;search();});}
